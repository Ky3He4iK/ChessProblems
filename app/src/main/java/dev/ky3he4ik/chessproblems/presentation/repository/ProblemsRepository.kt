...
interface ProblemsRepository {
    ...
    fun <T : ProblemInfo> getUnsolvedProblemsLive(lifecycleOwner: LifecycleOwner, userId: Int): LiveData<List<T>>
    fun <T : ProblemInfo> getSolvedProblemsLive(lifecycleOwner: LifecycleOwner, userId: Int): LiveData<List<T>>
